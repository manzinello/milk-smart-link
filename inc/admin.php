...
{
    add_menu_page('Milk smart link', 'Milk smart link', 'manage_options', 'milk-smartlink', 'milk_settings_page', 'http://localhost:8888/wordpress/wp-content/plugins/milk-smartlink/assets/milk-icon.png');
}
